...
class UpdateStudent implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update student set name='"+t1.getText()+"',fathers_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone_no='"+t6.getText()+"',email_id='"+t7.getText()+"',class_per_10='"+t8.getText()+"',class_per_12='"+t9.getText()+"',adhar_no='"+t10.getText()+"',course='"+t13.getText()+"',branch='"+t14.getText()+"' where roll_no='"+t12.getText()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                conn con = new conn();
                String str = "select * from student where roll_no = '"+t12.getText()+"'";
